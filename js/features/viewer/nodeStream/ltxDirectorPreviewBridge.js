...
function _signatureFor(node, canvas) {
 ...
 * @returns {object|null}
 */
export function extractLtxDirectorPreview(node) {
    if (!node) return null;
...
export function hasLtxDirectorPreviewState(node) {
