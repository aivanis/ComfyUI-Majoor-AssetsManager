import { _ as nn, j as on, k as tn, A as B, l as en, m as rn, o as cn } from "./entry-B5M8pQrP.js";
...
const un = { style: { display: "flex", "flex-direction": "column", gap: "10px", "margin-bottom": "14px" } }, fn = {
...
}, _n = { style: { margin: "0", padding: "10px 12px", "max-height": "280px", overflow: "auto", "font-size": "11px", "line-height": "1.35", color: "rgba(255,255,255,0.86)" } }, an = {
  ...
  setup(n) {
    ...
    function g(i) {
      ...
      return !!(r.width && r.height || r.duration && r.duration > 0 || y || r.size && r.size > 0 || r.id != null || r.job_id || (a = r.file_info) != null && a.job_id || r.source_node_id || (f = r.file_info) != null && f.source_node_id || r.source_node_type || (h = r.file_info) != null && h.source_node_type);
    }
    function _(i) {
      if (i == null) return "";
...
Click to retry.`;
    ...
    return (i, r) => (E(), R("div", un, [
      ...
      x.value ? (E(), R("div", gn, " No generation data found for this file. ")) : O("", !0),
      k.value ? (E(), R("details", yn, [
...
const P = ((U = B) == null ? void 0 : U.VIEWER_GENINFO_MAX_ENTRIES) ?? 300, V = /* @__PURE__ */ new Map(), W = /* @__PURE__ */ new Map(), C = /* @__PURE__ */ new Map(), mn = (n, t, e) => {
  ...
  try {
    const d = Date.now();
    for (const [g, _] of n.entries()) {
      if (!_) {
        n.delete(g);
        continue;
      }
      d - (_.at || 0) > t && n.delete(g);
    }
    if (n.size <= e) return;
...
async function jn(n, { getAssetMetadata: t, getFileMetadataScoped: e, metadataCache: c, signal: u } = {}) {
  ...
  const p = async () => {
    ...
    const N = !!(o != null && o.has_generation_data || o != null && o.has_workflow || o != null && o.has_generation || o != null && o.has_generation_info), k = !!(o != null && o.geninfo || o != null && o.prompt || o != null && o.workflow || o != null && o.metadata);
    let x = null;
    if (d != null && (!F(o) || N && !k)) {
      const f = await L(
    ...
    if (!F(o))
      try {
        const f = String((o == null ? void 0 : o.source) || (o == null ? void 0 : o.type) || "output").trim().toLowerCase() || "output", h = String(
        ...
        if (h) {
          ...
          w != null && w.ok && w.data ? o = kn({ ...o }, w.data) : w && (w == null ? void 0 : w.code) !== "ABORTED" && (x = {
            kind: "fetch_error",
            stage: "file_scoped",
    ...
    if (xn(o), !F(o) && x) {
      const f = wn(o);
      f && f.kind === "media_pipeline" || J(o, x);
    }
    return F(o) && l ? H(V, l, o, A, P) : x && l && H(
      W,
      l,
      x,
      M,
...
...(truncated)`), _.textContent = p, o.appendChild(g), o.appendChild(_), u.appendChild(o);
  }
  return u;
}
export {
