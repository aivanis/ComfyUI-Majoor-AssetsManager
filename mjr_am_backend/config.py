...
def get_runtime_output_root() -> str:
    ...
    """
    env_path = str(os.getenv("MAJOOR_OUTPUT_DIRECTORY") or "").strip()
    if env_path:
        try:
...
BG_SCAN_MIN_INTERVAL_SECONDS = env_float("MAJOOR_BG_SCAN_MIN_INTERVAL_SECONDS", 30.0)
...
SCAN_BATCH_SMALL = _env_int("MAJOOR_SCAN_BATCH_SMALL", 100)
SCAN_BATCH_MED = _env_int("MAJOOR_SCAN_BATCH_MED", 150)
SCAN_BATCH_LARGE = _env_int("MAJOOR_SCAN_BATCH_LARGE", 250)
...
SCAN_BATCH_XL = _env_int("MAJOOR_SCAN_BATCH_XL", 400)
