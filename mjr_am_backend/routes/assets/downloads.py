"""Download helper functions extracted from the asset handler."""
...
from .path_guard import build_download_response as _pg_build_download_response
from .path_guard import safe_download_filename as _pg_safe_download_filename
...
async def handle_download_asset(
    ...
    *,
    ...
    """Serve a file download after the handler module resolves local dependencies."""
...
async def handle_download_clean_asset(
    ...
    *,
    ...
    """Serve a sanitized download with ComfyUI metadata removed when supported."""
...
def register_download_routes(
    ...
    *,
    download_asset_handler: Callable[[web.Request], Any],
    download_clean_asset_handler: Callable[[web.Request], Any],
) -> None:
